...
<body>
    ...
    <main class="container py-4">
        ...
        <div class="my-4 p-3 rounded text-center" style="border:1px dashed rgba(212,175,55,.5); background:rgba(212,175,55,.06);">
            ...
            <p class="mb-1"><strong class="text-warning">🧾 支线 · 天机残页·叁 · 口令：<code><?= e(xxr_egg_secret('egg_slip_3')) ?></code></strong></p>
            <p class="mb-0 small text-muted">
                （支线任务，不影响主线通关。口令到 <a href="/tianji">✨天机阁</a> 兑换。
                下一环的具体操作：随便访问一个<strong>不存在的页面</strong>（例如 /abc），在 404 页的源码里读「迷路诗」的注释）
            </p>
        </div>
        <?php endif; ?>
