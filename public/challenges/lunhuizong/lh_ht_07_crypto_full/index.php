...
/**
 * 【轮回宗·合体】幽冥界·密码学篇
 * 修真叙事：幽冥界的密码学谜题：ECB + Hash 长度扩展 + JWT + Padding Oracle。
...
<head>
    <meta charset="UTF-8">
    <title>【轮回宗·合体】幽冥界·密码学篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【轮回宗·合体】幽冥界·密码学篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 幽冥界的密码学谜题：ECB + Hash 长度扩展 + JWT + Padding Oracle。
每解开一道谜题可获得一段线索，最终拼出《幽冥天书》。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flaglh_ht_07_crypto_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/LH-HT-07" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>