...
/**
 * 【轮回宗·合体】万魔殿·业务逻辑篇
 * 修真叙事：万魔殿业务逻辑综合：支付篡改 + 并发漏洞 + 状态机绕过。
...
<head>
    <meta charset="UTF-8">
    <title>【轮回宗·合体】万魔殿·业务逻辑篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【轮回宗·合体】万魔殿·业务逻辑篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 万魔殿业务逻辑综合：支付篡改 + 并发漏洞 + 状态机绕过。
修真业务系统漏洞百出，你将综合利用业务逻辑漏洞获取最大利益。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flaglh_ht_10_logic_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/LH-HT-10" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>