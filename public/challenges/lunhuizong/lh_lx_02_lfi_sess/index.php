...
/**
 * 【轮回宗·炼虚】轮回之袋
 * 修真叙事：轮回宗用 Session 保存轮回弟子的灵魂印记。若你能控制 Session 内容，且 Session 文件路径可被 LFI 包含，
...
<head>
    <meta charset="UTF-8">
    <title>【轮回宗·炼虚】轮回之袋 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【轮回宗·炼虚】轮回之袋</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 轮回宗用 Session 保存轮回弟子的灵魂印记。若你能控制 Session 内容，且 Session 文件路径可被 LFI 包含，
即可实现远程代码执行。这是轮回宗历史上最危险的一次漏洞。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flaglh_lx_02_lfi_sess_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/LH-LX-02" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>