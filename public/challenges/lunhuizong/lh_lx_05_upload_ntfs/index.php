...
/**
 * 【轮回宗·炼虚】NTFS 流
 * 修真叙事：轮回宗在 Windows 服务器下部署。利用 NTFS 备用数据流（Alternate Data Stream），
...
<head>
    <meta charset="UTF-8">
    <title>【轮回宗·炼虚】NTFS 流 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【轮回宗·炼虚】NTFS 流</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 轮回宗在 Windows 服务器下部署。利用 NTFS 备用数据流（Alternate Data Stream），
文件名 `shell.php::$DATA` 在某些校验中会被识别为非 PHP 文件，但实际内容仍按 PHP 解析。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flaglh_lx_05_upload_ntfs_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/LH-LX-05" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>