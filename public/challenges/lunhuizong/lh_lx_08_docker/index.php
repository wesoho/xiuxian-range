...
/**
 * 【轮回宗·炼虚】Docker 越界
 * 修真叙事：轮回宗部署在 Docker 容器中。若容器以特权模式运行，攻击者可挂载宿主机文件系统，
...
<head>
    <meta charset="UTF-8">
    <title>【轮回宗·炼虚】Docker 越界 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【轮回宗·炼虚】Docker 越界</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 轮回宗部署在 Docker 容器中。若容器以特权模式运行，攻击者可挂载宿主机文件系统，
逃逸到宿主机。教学演示 docker.sock、/proc/self/exe 等逃逸路径。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flaglh_lx_08_docker_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/LH-LX-08" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>