...
/**
 * 【青云宗·合体】藏经阁·SQL篇
 * 修真叙事：藏经阁的 SQL 考验：从 UNION 注入到盲注再到 GetShell 完整链路。
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·合体】藏经阁·SQL篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·合体】藏经阁·SQL篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 藏经阁的 SQL 考验：从 UNION 注入到盲注再到 GetShell 完整链路。
你需要在不同场景下灵活运用各类注入手法，最终获取《藏经阁秘典》。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_ht_03_sqli_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-HT-03" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>