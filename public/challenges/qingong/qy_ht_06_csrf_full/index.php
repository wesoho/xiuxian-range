...
/**
 * 【青云宗·合体】阵法台·CSRF篇
 * 修真叙事：阵法台多道阵法需绕过：CSRF Token + CORS + SameSite + Referer。
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·合体】阵法台·CSRF篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·合体】阵法台·CSRF篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 阵法台多道阵法需绕过：CSRF Token + CORS + SameSite + Referer。
综合运用多种 CSRF 绕过技巧，方能突破阵法台。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_ht_06_csrf_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-HT-06" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>