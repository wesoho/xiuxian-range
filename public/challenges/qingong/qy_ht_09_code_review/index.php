...
/**
 * 【青云宗·合体】禁地·代码审计篇
 * 修真叙事：禁地藏有一个迷你 CMS。请审计其全部源码，找出所有漏洞并尝试利用。
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·合体】禁地·代码审计篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·合体】禁地·代码审计篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 禁地藏有一个迷你 CMS。请审计其全部源码，找出所有漏洞并尝试利用。
这是一个真实代码审计场景，考验你的综合分析与漏洞挖掘能力。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_ht_09_code_review_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-HT-09" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>