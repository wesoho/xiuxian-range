...
/**
 * 【青云宗·炼虚】.htaccess 诡道
 * 修真叙事：青云宗的 Apache 服务器允许上传 .htaccess 文件。攻击者上传一个特制的 .htaccess，
可将任意后缀文件（如 .jpg）按 PHP 解析，实现图片马的高级变种。
 * 漏洞类型：.htaccess 自定义解析 + 上传
 * 难度：终极挑战
 */
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·炼虚】.htaccess 诡道 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·炼虚】.htaccess 诡道</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 青云宗的 Apache 服务器允许上传 .htaccess 文件。攻击者上传一个特制的 .htaccess，
可将任意后缀文件（如 .jpg）按 PHP 解析，实现图片马的高级变种。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_lx_04_upload_hta_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-LX-04" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>