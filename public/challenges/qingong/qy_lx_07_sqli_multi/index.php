...
/**
 * 【青云宗·炼虚】mysqli 多语句
 * 修真叙事：mysqli_multi_query 允许多语句执行。攻击者可在 SQL 注入后追加 UPDATE/INSERT 等语句，
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·炼虚】mysqli 多语句 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·炼虚】mysqli 多语句</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> mysqli_multi_query 允许多语句执行。攻击者可在 SQL 注入后追加 UPDATE/INSERT 等语句，
直接修改数据库（如改管理员密码、清空订单），实现持久化控制。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_lx_07_sqli_multi_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-LX-07" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>