...
/**
 * 【青云宗·炼虚】缓存成魔
 * 修真叙事：高级缓存投毒。青云宗使用 Varnish + ESI 标签，攻击者通过 X-Forwarded-Host 等头污染缓存键，
使后续所有用户访问时被返回恶意内容。
 * 漏洞类型：高级缓存投毒
 * 难度：终极挑战
 */
...
<head>
    <meta charset="UTF-8">
    <title>【青云宗·炼虚】缓存成魔 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【青云宗·炼虚】缓存成魔</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 高级缓存投毒。青云宗使用 Varnish + ESI 标签，攻击者通过 X-Forwarded-Host 等头污染缓存键，
使后续所有用户访问时被返回恶意内容。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagqy_lx_10_cache_adv_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/QY-LX-10" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>