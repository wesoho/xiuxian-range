...
/**
 * 【大乘】跨宗渗透·青云→万魔
 * 修真叙事：修真界百年难遇的飞升试炼开启。从青云宗内部网络渗透到万魔宗禁地，
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】跨宗渗透·青云→万魔 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】跨宗渗透·青云→万魔</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 修真界百年难遇的飞升试炼开启。从青云宗内部网络渗透到万魔宗禁地，
获取《魔道真经》。综合运用情报收集、边界突破、身份伪造、权限提升四阶段。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_01_cross_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-01" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>