...
/**
 * 【大乘】跨宗渗透·万魔→轮回
 * 修真叙事：从万魔宗反攻轮回殿，结合 SSRF、反序列化、XSS 三大绝技，
取回《轮回天书》。
 * 漏洞类型：跨宗门 SSRF + 反序列化 + XSS
 * 难度：终极挑战
 */
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】跨宗渗透·万魔→轮回 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】跨宗渗透·万魔→轮回</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 从万魔宗反攻轮回殿，结合 SSRF、反序列化、XSS 三大绝技，
取回《轮回天书》。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_02_cross_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-02" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>