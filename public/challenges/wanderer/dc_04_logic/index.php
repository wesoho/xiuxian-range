...
/**
 * 【大乘】社交平台逻辑漏洞
 * 修真叙事：修真社交平台的逻辑漏洞综合：粉丝 + 关注 + 私信 + 状态机。
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】社交平台逻辑漏洞 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】社交平台逻辑漏洞</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 修真社交平台的逻辑漏洞综合：粉丝 + 关注 + 私信 + 状态机。
综合运用业务逻辑漏洞，实现越权、刷量、信息泄露。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_04_logic_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-04" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>