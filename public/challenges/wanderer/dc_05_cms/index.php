...
/**
 * 【大乘】CMS 代码审计挑战
 * 修真叙事：审计一个完整的 CMS 系统，找出 5 个以上漏洞并利用。
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】CMS 代码审计挑战 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】CMS 代码审计挑战</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 审计一个完整的 CMS 系统，找出 5 个以上漏洞并利用。
真实代码审计场景，需要从海量代码中发现蛛丝马迹。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_05_cms_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-05" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>