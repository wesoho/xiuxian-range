...
/**
 * 【大乘】API 安全全链路
 * 修真叙事：REST/GraphQL API 的全链路安全挑战：认证、授权、注入、限流、信息泄露。
考验你对现代 API 安全的全面掌握。
 * 漏洞类型：API 安全综合
 * 难度：终极挑战
 */
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】API 安全全链路 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】API 安全全链路</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> REST/GraphQL API 的全链路安全挑战：认证、授权、注入、限流、信息泄露。
考验你对现代 API 安全的全面掌握。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_06_api_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-06" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>