...
<head>
    <meta charset="UTF-8">
    <title>【大乘】内网穿透完整链 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】内网穿透完整链</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> Web 漏洞 → 内网 → 域控 → 提权的完整链。
模拟真实内网渗透，从 Web 入口一路打到域控。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_07_intranet_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-07" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>