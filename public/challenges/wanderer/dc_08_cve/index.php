<?php
/**
 * 【大乘】真实 CVE 复现·ThinkPHP5 RCE
 * 修真叙事：复现 ThinkPHP 5.0.23 远程代码执行漏洞（CVE-2018-20062）。
真实漏洞复现，体验历史漏洞的危害。
 * 漏洞类型：真实 CVE 复现
 * 难度：终极挑战
 */
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】真实 CVE 复现·ThinkPHP5 RCE · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】真实 CVE 复现·ThinkPHP5 RCE</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 复现 ThinkPHP 5.0.23 远程代码执行漏洞（CVE-2018-20062）。
真实漏洞复现，体验历史漏洞的危害。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_08_cve_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-08" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>