...
/**
 * 【大乘】CTF 夺旗综合题
 * 修真叙事：CTF 风格的综合夺旗挑战：逆向 + Web + 密码学 + 隐写。
多步骤组合，需要持续思考。
 * 漏洞类型：CTF 综合题
 * 难度：终极挑战
 */
...
<head>
    <meta charset="UTF-8">
    <title>【大乘】CTF 夺旗综合题 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【大乘】CTF 夺旗综合题</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> CTF 风格的综合夺旗挑战：逆向 + Web + 密码学 + 隐写。
多步骤组合，需要持续思考。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagdc_09_ctf_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/DC-09" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>