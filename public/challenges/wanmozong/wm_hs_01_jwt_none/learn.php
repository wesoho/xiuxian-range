...
<body class="bg-dark text-light">
    <div class="container py-5">
        ...
        <div class="bg-dark-translucent p-4 rounded mt-3">
            ...
            <p class="text-muted">JWT alg=none</p>
        </div>
        <div class="bg-dark-translucent p-4 rounded mt-3">
            <h5 class="text-gold">🛡️ 安全修真心法</h5>
            <p>强制HS256/RS256；使用firebase/php-jwt</p>
        </div>
        <div class="text-center mt-4">
            <a href="/challenge/WM-HS-01" class="xxr-btn xxr-btn-secondary">← 返回关卡</a>
        </div>
    </div>
</body>
</html>