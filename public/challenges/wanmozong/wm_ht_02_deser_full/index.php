...
/**
 * 【万魔宗·合体】魔窟·反序列化篇
 * 修真叙事：魔窟深处有多个反序列化陷阱：__wakeup 绕过、POP 链构造、Phar 反序列化、Session 反序列化。
...
<head>
    <meta charset="UTF-8">
    <title>【万魔宗·合体】魔窟·反序列化篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【万魔宗·合体】魔窟·反序列化篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 魔窟深处有多个反序列化陷阱：__wakeup 绕过、POP 链构造、Phar 反序列化、Session 反序列化。
你需要综合运用所有反序列化技巧，方能逃出魔窟。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagwm_ht_02_deser_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/WM-HT-02" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>