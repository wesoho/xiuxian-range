...
/**
 * 【万魔宗·合体】炼魂殿·SSRF篇
 * 修真叙事：炼魂殿有 SSRF 综合挑战：内网探测 + Redis 攻击 + 协议利用。
...
<head>
    <meta charset="UTF-8">
    <title>【万魔宗·合体】炼魂殿·SSRF篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【万魔宗·合体】炼魂殿·SSRF篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 炼魂殿有 SSRF 综合挑战：内网探测 + Redis 攻击 + 协议利用。
你将利用 gopher:// 等协议攻击内网服务，最终获取《炼魂秘术》。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagwm_ht_05_ssrf_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/WM-HT-05" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>