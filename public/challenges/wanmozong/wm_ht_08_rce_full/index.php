...
/**
 * 【万魔宗·合体】血池·RCE篇
 * 修真叙事：血池 RCE 综合：空格过滤 + 关键字过滤 + 无字母数字绕过。
...
<head>
    <meta charset="UTF-8">
    <title>【万魔宗·合体】血池·RCE篇 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【万魔宗·合体】血池·RCE篇</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 血池 RCE 综合：空格过滤 + 关键字过滤 + 无字母数字绕过。
层层递进的过滤让你必须掌握多种 RCE 绕过技巧。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagwm_ht_08_rce_full_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/WM-HT-08" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>