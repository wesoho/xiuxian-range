...
<body class="bg-dark text-light">
    <div class="container py-5">
        ...
        <div class="bg-dark-translucent p-4 rounded mt-3">
            ...
            <p class="text-muted">文件上传黑名单绕过</p>
        </div>
        <div class="bg-dark-translucent p-4 rounded mt-3">
            <h5 class="text-gold">🛡️ 安全修真心法</h5>
            <p>使用白名单而非黑名单；Apache配置禁止脚本执行；随机文件名</p>
        </div>
        <div class="text-center mt-4">
            <a href="/challenge/WM-JD-14" class="xxr-btn xxr-btn-secondary">← 返回关卡</a>
        </div>
    </div>
</body>
</html>