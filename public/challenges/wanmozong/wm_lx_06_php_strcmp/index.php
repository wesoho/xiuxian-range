...
/**
 * 【万魔宗·炼虚】strcmp 陷阱
 * 修真叙事：strcmp 在接收数组类型时返回 NULL，配合 == 弱比较时 NULL == 0 为真。
...
<head>
    <meta charset="UTF-8">
    <title>【万魔宗·炼虚】strcmp 陷阱 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【万魔宗·炼虚】strcmp 陷阱</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> strcmp 在接收数组类型时返回 NULL，配合 == 弱比较时 NULL == 0 为真。
万魔宗用 strcmp 校验密码哈希，攻击者传入数组即可绕过登录。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagwm_lx_06_php_strcmp_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/WM-LX-06" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>