...
/**
 * 【万魔宗·炼虚】CGI 漏洞
 * 修真叙事：万魔宗仍使用 PHP-CGI 模式（而非 FastCGI/PHP-FPM），存在 CVE-2024-4577 等历史漏洞。
...
<head>
    <meta charset="UTF-8">
    <title>【万魔宗·炼虚】CGI 漏洞 · 修真靶场</title>
    <link href="/assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/css/xiuxian.css" rel="stylesheet">
</head>
<body class="bg-dark text-light">
    <div class="container py-5">
        <h2 class="text-gold">【万魔宗·炼虚】CGI 漏洞</h2>
        <div class="xxr-narrative">
            <strong>📖 剧情：</strong> 万魔宗仍使用 PHP-CGI 模式（而非 FastCGI/PHP-FPM），存在 CVE-2024-4577 等历史漏洞。
Windows 下利用 Softaculous 特性，攻击者可注入任意 PHP 配置。
        </div>
        ...
        <div class="alert alert-info mt-4">
            ...
            <hr>
            Flag: <code class="xxr-mono">flagwm_lx_09_php_cgi_check_db</code>
            （具体 Flag 在数据库 challenges 表中）
        </div>

        <div class="text-center mt-4">
            <a href="/challenge/WM-LX-09" class="xxr-btn xxr-btn-secondary">← 返回关卡详情</a>
        </div>
    </div>
</body>
</html>